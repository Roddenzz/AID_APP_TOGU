...
class _StudentChatScreenState extends State<StudentChatScreen> {
  ...
  // In a real app, the staff/recipient ID would be dynamic.
  // For this demo, we'll hardcode a recipient ID for the staff.
  final String _staffRecipientId = 'staff_admin_01';
  ...
  Future<void> _loadMessageHistory() async {
    ...
    final history = await _chatService.getConversation(userId, _staffRecipientId);
    setState(() {
      _messages = history;
      _isLoading = false;
    });
